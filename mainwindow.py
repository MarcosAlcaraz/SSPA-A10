...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.OrdenarAscendenteID_pushbutton.clicked.connect(self.accionMostrarTablaSBID)
        self.ui.OrdenarAscendenteVelocidad_pushbutton.clicked.connect(self.accionMostrarTablaSBS)
        self.ui.OrdenarDescendenteDistancia_pushbutton.clicked.connect(self.accionMostrarTablaSBD)
